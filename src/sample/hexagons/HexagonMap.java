...
public class HexagonMap {
    ...
    public IHexagonClickedCallback onHexClickedCallback = hexagon -> {
    };
    ...
    public HexagonMap(int hexagonSize, int mapHeightInHexes, int mapWidthInHexes) {
        this.hexagonSize = hexagonSize;
        mapGenerator = new MapGenerator(this, mapHeightInHexes, mapWidthInHexes);
        mapGenerator.generate((q, r, map) -> {
