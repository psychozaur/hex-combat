...
public class Hexagon extends Polygon {
    ...
    public Optional<Unit> getMaybeUnitOwner(List<Unit> unitList){
        Optional<Unit> maybeResult;

        maybeResult = unitList.stream()
                .filter(unit -> unit.getCurrentHex().equals(this))
                .findFirst();
